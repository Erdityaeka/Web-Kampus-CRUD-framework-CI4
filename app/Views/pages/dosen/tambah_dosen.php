        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form role="form" method="post" action="tambahdsn" enctype="multipart/form-data">

                            <div class="form-group">
                                <label>NIDN</label>
                                <input class="form-control" placeholder="Enter text" name="nidn">
                            </div>
                            <div class="form-group">
                                <label>Nama</label>
                            ...
                            <div class="form-group">
                                <label>Telpon</label>
                                <input class="form-control" placeholder="Enter text" name="tlpn">
                            </div>
